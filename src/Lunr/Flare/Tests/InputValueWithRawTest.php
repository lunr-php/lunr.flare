...
/**
 * This file contains the InputValueWithRawTest class.
 *
 ...
 */
class InputValueWithRawTest extends InputValueTestCase
{
    ...
    {
        $this->class = new InputValue('key1', 'value1', 'rawvalue1');
    ...
    {
        $this->assertPropertySame('rawValue', 'rawvalue1');
    }
